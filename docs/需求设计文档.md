...
#### 4.2.2 太阳位置预计算表 (solar_positions_precalc)
```sql
...
#### 4.2.3 阴影分析记录表 (shadow_analysis_cache)
```sql
...
- **协议**: HTTPS
- **数据格式**: JSON
- **认证**: 无需认证 (公开数据) 或 JWT Token (用户特定功能)
- **基础路径**: `/api/v1`
